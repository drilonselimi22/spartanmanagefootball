...
namespace SpartanManageFootball.Migrations
{
    ...
    [Migration("20220705084319_ChangedTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpartanManageFootball.Models.StandingsTable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SquadDraws")
                        .HasColumnType("int");

                    b.Property<int>("SquadIdTeamId")
                        .HasColumnType("int");

                    b.Property<int>("SquadLosses")
                        .HasColumnType("int");

                    b.Property<int>("SquadPoints")
                        .HasColumnType("int");

                    b.Property<int>("SquadWins")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SpartanManageFootball.Models.StandingsTable", b =>
                {
                    ...
                    b.HasOne("SpartanManageFootball.Models.Squad", "SquadId")
                        .WithMany()
                        .HasForeignKey("SquadIdTeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LeagueId");

                    b.Navigation("SquadId");
                });
